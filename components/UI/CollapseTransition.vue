...
export default {
  ...
  emits: ['appear', 'enter', 'leave', 'beforeAppear', 'afterAppear', 'appearCancelled', 'beforeEnter', 'afterEnter', 'enterCancelled', 'beforeLeave', 'leaveCancelled', 'interleave'],
