 ...
 * @param diff
 */
function getDiffType (type: DiffType) {
 ...
 * @param diffsMap
 */
function getSplitLines (diffsMap: Array<Diffs>): Array<Lines> {
 ...
 * @param diffsMap
 */
function getUnifiedLines (diffsMap: Array<Diffs>): Array<Lines> {
 ...
 * @param current
 */
function renderLines (mode: Mode,
  prev: string,
  current: string): Array<Lines> {
 ...
 * @param current
 */
function renderWords (prev: string, current: string) {
  /**
